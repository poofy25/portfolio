...
export default function ContactSection () {
    ...
    return (
        <div id='contact' className="flex flex-col items-center bg-primary-light px-[7.5vw] py-32 box-border w-full lg:px-[17.5vw] lg:items-start">
            <p data-aos="fade-down" className="font-semibold text-lg text-complimentary">CONTACT</p>
            <div  className="flex flex-col justify-between  gap-8 w-full h-fit lg:flex-row lg:gap-16">
                <div className="flex-1 flex flex-col items-center lg:items-start">
                    <h2 data-aos="fade-down"  className='mb-8 mt-4 text-center lg:text-start'>Don&apos;t be shy! Hit me up! 👇</h2> 
                    <h3 data-aos="fade-down" className=' mb-2 sm:hidden'>EMAIL</h3>
                    <Link data-aos="fade-down" title='Email' className="hover:text-complimentary transition-all sm:hidden" href='mailto:buzacristian25@gmail.com'>buzacristian25@gmail.com</Link>


                    <div data-aos="fade-down" className="flex items-center h-fit w-full gap-2 mb-4 justify-center lg:justify-start">
                    ...
                    <h3 data-aos="fade-down" className="mb-2">SOCIALS</h3>
                    <div className="flex gap-4 items-start">
                        <div data-aos="fade-down" data-aos-delay="100"  className="flex items-center h-fit gap-2 ">
                        ...
                        <div data-aos="fade-down" data-aos-delay="200"  className="flex items-center h-fit gap-2">
                        ...
                        <div data-aos="fade-down" data-aos-delay="300"  className="flex items-center h-fit gap-2">
                        ...
                        <div data-aos="fade-down" data-aos-delay="400"  className="flex items-center h-fit gap-2">
                ...
                <div className="flex-1 flex flex-col ">
                    <h2 data-aos="fade-down" className='flex-1 mb-8 text-center lg:mt-4 lg:text-start'>Or leave me a message! 💬</h2>
                    <ContactForm/>
