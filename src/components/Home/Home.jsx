        ...
        <article id='home' className="bg-transparent w-full min-h-[calc(100vh-80px)] gap-8 flex flex-col justify-between py-8 pb-16 px-[7.5vw] lg:py-[80px] lg:pb-32 lg:px-[17.5vw] box-border"> 
            ...
            ">
                <div className="flex flex-col items-center gap-4 flex-1 pt-8 lg:gap-6 lg:py-10 lg:items-start">
                    <h1 className="font-bold text-4xl text-center lg:text-left lg:text-5xl inline">Buza Cristian <br/>Web Developer</h1> 
                    <p className="text-lg text-center lg:text-left opacity-90">Hi, I&apos;m Buza Cristian. A passionate React Web Developer based in Moldova. 📍</p>
                    ...
                    ">
                        ...
                        <div className='flex gap-2 justify-evenly w-full lg:w-fit'>
                ...
                <div className="w-[85%] lg:w-[40%] max-w-[350px]  aspect-square relative heroImg">
            ...
            <div className='flex flex-col items-center gap-4 h-fit lg:flex-row lg:gap-6'>
                <p className='font-bold text-lg  border-0 border-b-2 border-solid border-secondary lg:border-0'>Skills</p>
                <span className='hidden lg:flex w-[2px] h-8 bg-secondary rounded opacity-75'></span>
